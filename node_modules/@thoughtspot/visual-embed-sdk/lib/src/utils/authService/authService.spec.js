...
describe('Unit test for authService', () => {
    ...
    test('fetchAuthService', async () => {
        ...
        expect(fetch).toHaveBeenCalledWith(`${thoughtSpotHost}${EndPoints.TOKEN_LOGIN}?username=${username}&auth_token=${authToken}`, {
            credentials: 'include',
            redirect: 'manual',
        });
    });
    test('fetchAuthService without username', async () => {
        ...
        expect(fetch).toHaveBeenCalledWith(`${thoughtSpotHost}${EndPoints.TOKEN_LOGIN}?auth_token=${authToken}`, {
            credentials: 'include',
            redirect: 'manual',
        });
    });
